...
#### Version 1.8  
1. [GitHub release](https://github.com/dipu-bd/UVA-Arena/releases/download/v1.8/UVA_Arena_1.8.exe)
2. [SourceForge mirror](https://sourceforge.net/projects/uvaarena/files/UVA%20Arena%201.8/UVA_Arena_1.8.exe)

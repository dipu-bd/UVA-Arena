...
namespace UVA_Arena
{
    ...
    public static class FormAPI
    {
        ...
        public static void ExtendClientArea(Form form, Padding margin)
        {
            MARGINS mar = new MARGINS(margin);
            DwmExtendFrameIntoClientArea(form.Handle, ref mar);
        }

...
void showProblemList(QList<uva::ProblemInfo> data)
{
    ...
    {
        cout << info.getProblemNumber() << " - "
             << info.getProblemTitle().toStdString() << " "
             << info.getDACU() << " " << info.getAcceptedCount() << " "
             << info.getTotalSubmission() << endl;
    }
    cout << endl;
}
void showJudgeStatus(QList<uva::JudgeStatus> data)
{
    ...
    {
        cout << stat.getId() << " " << stat.getSubmissionID() << " "
             << stat.getFullName().toStdString() << " " << stat.getProblemID() << " "
             << stat.getVerdict() << " " << stat.getLanguage() << " "
             << stat.getSubmissionTime() << endl;
    }
    cout << endl;
}
...
int main(int argc, char* argv[])
{
    ...
    getJudgeStatusButton.setText("Click me to get the judge status list");
